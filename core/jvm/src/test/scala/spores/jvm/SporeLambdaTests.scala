...
class SporeLambdaTests:
  ...
  def testLambdaWithEnv(): Unit =
    val packed9 = Spore.applyWithEnv(9) { x => x > 10 }
    val packed11 = Spore.applyWithEnv(11) { x => x > 10 }
    assertFalse(packed9.unwrap())
    assertTrue(packed11.unwrap())

  @Test
  def testLambdaWithCtx(): Unit =
    val packed9 = Spore.applyWithCtx(9) { summon[Int] > 10 }
    val packed11 = Spore.applyWithCtx(11) { summon[Int] > 10 }
    assertFalse(packed9.unwrap())
    assertTrue(packed11.unwrap())
  ...
  def testPackedLambdaReadWriter(): Unit =
    val json = """{"$type":"spores.Packed.PackedLambda","funName":"spores.jvm.SporeLambdaTests$Lambda$10"}"""
  ...
  def testNestedLambdaReadWriter(): Unit =
    val json = """{"$type":"spores.Packed.PackedLambda","funName":"spores.jvm.SporeLambdaTests$NestedLambda$Lambda$12"}"""
  ...
  def testPackedLambdaWithEnvReadWriter(): Unit =
    val json9 = """{"$type":"spores.Packed.PackedWithEnv","packed":{"$type":"spores.Packed.PackedLambda","funName":"spores.jvm.SporeLambdaTests$Lambda$10"},"packedEnv":{"$type":"spores.Packed.PackedEnv","env":"9","rw":{"$type":"spores.Packed.PackedObject","funName":"spores.ReadWriters$IntRW$"}}}"""
    val json11 = """{"$type":"spores.Packed.PackedWithEnv","packed":{"$type":"spores.Packed.PackedLambda","funName":"spores.jvm.SporeLambdaTests$Lambda$10"},"packedEnv":{"$type":"spores.Packed.PackedEnv","env":"11","rw":{"$type":"spores.Packed.PackedObject","funName":"spores.ReadWriters$IntRW$"}}}"""
  ...
  def testLambdaWithEnvConstructorReadWriter(): Unit =
    val json = """{"$type":"spores.Packed.PackedWithEnv","packed":{"$type":"spores.Packed.PackedLambda","funName":"spores.jvm.SporeLambdaTests$Lambda$11"},"packedEnv":{"$type":"spores.Packed.PackedEnv","env":"11","rw":{"$type":"spores.Packed.PackedObject","funName":"spores.ReadWriters$IntRW$"}}}"""

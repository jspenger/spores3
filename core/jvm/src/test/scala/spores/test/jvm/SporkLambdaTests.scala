...
class SporeLambdaTests:
  ...
  def testPackedLambdaReadWriter(): Unit =
    val json = """{"$type":"spores.Packed.PackedLambda","fun":"spores.jvm.SporeLambdaTests$Lambda$10"}"""
  ...
  def testNestedLambdaReadWriter(): Unit =
    val json = """{"$type":"spores.Packed.PackedLambda","fun":"spores.jvm.SporeLambdaTests$NestedLambda$Lambda$12"}"""
  ...
  def testPackedLambdaWithEnvReadWriter(): Unit =
    val json9 = """{"$type":"spores.Packed.PackedWithEnv","packed":{"$type":"spores.Packed.PackedLambda","fun":"spores.jvm.SporeLambdaTests$Lambda$10"},"packedEnv":{"$type":"spores.Packed.PackedEnv","env":"9","rw":{"$type":"spores.Packed.PackedObject","fun":"spores.ReadWriters$IntRW$"}}}"""
    val json11 = """{"$type":"spores.Packed.PackedWithEnv","packed":{"$type":"spores.Packed.PackedLambda","fun":"spores.jvm.SporeLambdaTests$Lambda$10"},"packedEnv":{"$type":"spores.Packed.PackedEnv","env":"11","rw":{"$type":"spores.Packed.PackedObject","fun":"spores.ReadWriters$IntRW$"}}}"""
  ...
  def testLambdaWithEnvConstructorReadWriter(): Unit =
    val json = """{"$type":"spores.Packed.PackedWithEnv","packed":{"$type":"spores.Packed.PackedLambda","fun":"spores.jvm.SporeLambdaTests$Lambda$11"},"packedEnv":{"$type":"spores.Packed.PackedEnv","env":"11","rw":{"$type":"spores.Packed.PackedObject","fun":"spores.ReadWriters$IntRW$"}}}"""

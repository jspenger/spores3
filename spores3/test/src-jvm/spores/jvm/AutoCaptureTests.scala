...
object AutoCaptureTests extends TestSuite {
  import AutoCaptureTestsDefs.*
  ...
  val tests = Tests {
    ...
    test("testCaptures01234") {
      ...
      assert("hello" == unwrapped0("hello"))
      assert("hello" + a1 == unwrapped1("hello"))
      assert("hello" + a1 + a2 == unwrapped2("hello"))
      assert("hello" + a1 + a2 + a3 == unwrapped3("hello"))
      assert("hello" + a1 + a2 + a3 + a4 == unwrapped4("hello"))

      assert(1 == countCapturedInSpore(fun1, a1))
      assert(1 == countCapturedInSpore(fun2, a1))
      assert(1 == countCapturedInSpore(fun2, a2))
      assert(1 == countCapturedInSpore(fun3, a1))
      assert(1 == countCapturedInSpore(fun3, a2))
      assert(1 == countCapturedInSpore(fun3, a3))
      assert(1 == countCapturedInSpore(fun4, a1))
      assert(1 == countCapturedInSpore(fun4, a2))
      assert(1 == countCapturedInSpore(fun4, a3))
      assert(1 == countCapturedInSpore(fun4, a4))
    }
    ...
    test("testCapturedIdentExactlyOnce") {
      ...
      val unwrapped = writeReadUnwrap(fun)
      assert("0123456789" + c + c + c + c == unwrapped("0123456789"))
      assert(1 == countCapturedInSpore(fun, c))
    }

    test("testReadFun0123") {
      ...
      assert("hello" == u0("hello"))
      assert("hello" + a1 == u1("hello"))
      assert("hello" + a1 + a2 == u2("hello"))
      assert("hello" + a1 + a2 + a3.mkString(",") == u3("hello"))
    }
    ...
    test("testAsInstanceOfNoCapture") {
      ...
      val unwrapped = writeReadUnwrap(fun)
      assert(56 == unwrapped(List(Bar(42), Bar(14), Bar(73))))
    }
    ...
    test("testMethodTypeParamNoCapture") {
      ...
      val unwrapped = writeReadUnwrap(fun)
      assert(39 == unwrapped.apply(Bar(39)))
    }
    ...
    test("testParameterTypeNoCapture") {
      ...
      val unwrapped = writeReadUnwrap(fun)
      assert(76 == unwrapped(List(Bar(36), Bar(31)))(Bar(40)))
    }
